...
//!    represents the hierarchical structure of the source code and is used by the interpreter
//!    to execute the program.
...
/// an abstract syntax tree (AST) for the interpreter, by maintaining the state of the parsing process.
/// 
/// ## Fields
/// 
